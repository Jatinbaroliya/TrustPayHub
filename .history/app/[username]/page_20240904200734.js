    ...
    <>
      {params.username}
       ...
       <div className='cover w-full bg-red-50 relative'>
        ...
        <div className='absolute bottom-20 right-[46%] border-white border-2  round'>
           <img className='rounded-full' width={100} height={100} src="https://wallpaperaccess.com/full/1684069.jpg" alt="" />
        </div>
