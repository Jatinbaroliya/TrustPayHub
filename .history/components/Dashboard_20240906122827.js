        ...
        <div className="flex justify-center items-center min-h-screen text-white">
            <div className=" shadow-lg rounded-lg p-6 w-full max-w-lg">
                ...
                <form className="space-y-4">
                    ...
                    <div className="form-group">
                        <label htmlFor="profilePicture" className=" border-gray-300 block text-sm font-medium text-white">Profile Picture</label>
                        <input
                            type="file"
                            id="profilePicture"
                            name="profilePicture"
                    ...
                    <div className="form-group">
                        <label htmlFor="coverPicture" className="border-gray-300 block text-sm font-medium text-white">Cover Picture</label>
                        <input
                            type="file"
                            id="coverPicture"
                            name="coverPicture"
