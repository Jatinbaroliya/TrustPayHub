        ...
        <div className="flex justify-center items-center min-h-screen text-white">
            <div className=" shadow-lg rounded-lg p-6 w-full max-w-lg">
                ...
                <form className="space-y-4" action={handleSubmit}>
                    ...
                    <button type="submit" className="w-full bg-indigo-600 text-white py-4 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                            Save
                        </button>
                </form>
            </div>
