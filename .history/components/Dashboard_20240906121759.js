        ...
        <div className="flex justify-center items-center min-h-screen text-black">
            <div className=" shadow-lg rounded-lg p-6 w-full max-w-lg">
                ...
                <form className="space-y-4">
                    ...
                    <div className="form-group">
                        <label htmlFor="razorpayId" className="block text-sm font-medium ">Razorpay ID</label>
                        <input
                            type="text"
                            id="razorpayId"
                            name="razorpayId"
                    ...
                    <div className="form-group">
                        <label htmlFor="razorpaySecret" className="block text-sm font-medium ">Razorpay Secret</label>
                        <input
                            type="password"
                            id="razorpaySecret"
                            name="razorpaySecret"
