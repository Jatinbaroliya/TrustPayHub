                ...
                <form className="space-y-4">
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className="mt-1 block w-full p-2 bg- border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            required
                        />
                    </div>
