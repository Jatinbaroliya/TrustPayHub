    ...
    return (
        ...
        <div className="flex justify-center items-center min-h-screen text-black">
            <div className=" shadow-lg rounded-lg p-6 w-full max-w-lg">
                <h1 className="text-2xl font-bold mb-6 text-center text-w">Welcome to your Dashboard</h1>
                <form className="space-y-4">
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className="mt-1 block w-full p-2 bg-slate-900 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            required
                        />
                    </div>
