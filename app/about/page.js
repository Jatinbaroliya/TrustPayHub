      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-4xl bg-white rounded-lg shadow-lg m-16 md:m-0 md:p-16">
          ...
          <p className="text-lg text-gray-700 text-center mb-8">
            TrustPayHub is a crowdfunding platform created for passionate individuals and creators who want to connect with their community and turn their dreams into reality. Whether you&apos;re a writer, artist, musician, or builder — TrustPayHub empowers you through the support of your fans.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600">
                TrustPayHub aims to provide a smooth and transparent platform for creators to get support and funding from their audience. We believe in the strength of community and the impact of even the smallest contributions.
              </p>
            </div>
          ...
          <div className="mt-10 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Whether you&apos;re a creator looking for support or a fan who wants to make a difference — TrustPayHub gives you the platform to do just that. Together, we build dreams.
            </p>
            <Link href="/login">
